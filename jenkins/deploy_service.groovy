...
pipeline {
    ...
    stages {
        ...
        stage ('Deploy service abuses') {
            when {
                environment name: 'SERVICE_NAME', value: 'service-abuses'
            }
             steps {
                dir("packages/${env.SERVICE_NAME}/terraform") {
                    script {
